...
public class MyClass1 {
    public static void main(String[] args) throws IOException, ClassNotFoundException{
        ...
        String filePath = "/home/cmdq9/Documents/abc/MyClass2/userdata.txt";
    ...
    public static void addUser(ArrayList<String> name, ArrayList<String> surname,
    ...
    public static void updateUser(ArrayList<String> name, ArrayList<String> surname,
                                         ArrayList<String> emails,
                                         ArrayList<String> dateOfBirth, String filePath) throws IOException, ClassNotFoundException {
    ...
    public static void deleteUser(ArrayList<String> name, ArrayList<String> surname,
                                         ArrayList<String> emails,
                                         ArrayList<String> dateOfBirth, String filePath) throws IOException, ClassNotFoundException {
        ArrayList<ArrayList<String> > userDatabase;
        Scanner sc = new Scanner(System.in);
    ...
    public static void listUsers(ArrayList<String> name, ArrayList<String> surname,
                                 ArrayList<String> emails,
                                 ArrayList<String> dateOfBirth, String filePath) throws IOException, ClassNotFoundException {
        ArrayList<ArrayList<String> > userDatabase;
        try{
